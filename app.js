const qaItems = [
  ...
  {
    q: "你这中间 gap 了将近一年，怎么解释？",
    tags: ["career", "shortcoming"],
    angle: "不用包装成完整职业规划。自然承认空档，说明前期调整状态，后面看学校相关岗位、了解餐厅服务内容、准备基础英语，现在能稳定从基础岗位做起。",
    answer:
      "我上一份工作是 2025 年 7 月左右结束的，到现在确实有一段空档。刚离职的时候，我没有马上找工作，主要是想先调整一下状态，也想认真想清楚后面要不要继续做幼教。后来我考虑下来，还是希望继续在学校相关的环境里工作，但不一定继续做教学岗位。所以这段时间也陆续看了一些学校后勤、餐厅服务、运营协助类岗位，了解岗位内容，也准备了一些基础餐厅英语。现在方向比较清楚了，我希望找一份稳定的工作，从基础岗位开始做起。如果岗位需要餐前准备、现场服务、物资整理、卫生维护这些工作，我都可以接受，也愿意按学校的流程慢慢学。"
  },
  {
    q: "你没有餐饮服务经验，如何快速上手？",
